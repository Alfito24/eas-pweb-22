                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="photo"  class="form-control" value="{{ $user[0]->photo }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputStatus" name="role" class="form-control custom-select">
                                        ...
                                        <option value="student"  @if( $user[0]->role == 'student') selected
                                            @endif>Student</option>
                                        <option value="lecture"  @if( $user[0]->role == 'lecture') selected
                                            @endif>Lecture</option>
                                        <option value="admin"  @if( $user[0]->role == 'admin' ) selected
                                            @endif>Admin</option>
                                    </select>
                                </div>
                            </div>
